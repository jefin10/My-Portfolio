    ...
    <div className='flex flex-col justify-between h-full'>
      ...
      <div className='flex justify-center w-full h-12 mt-8 bg-transparent border-black lg:justify-start lg:ml-37p lg:mt-8p lg:w-1/5 border-1 rounded-xl'>
        <div className="card">
          ...
          <a href="https://github.com/jefin10" className="socialContainer containerTwo Link__github">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="30px" height="30px" className="github socialSvg">
          ...
          <a href="https://www.instagram.com/jefin._.francis/" className="socialContainer containerOne">
          ...
          <a href="https://wa.me/919990553806" className="socialContainer containerFour">
